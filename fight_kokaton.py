...
class Score:#スコアが表示できるようにする
    def __init__(self):
        self.fonto = pg.font.SysFont("hgp創英角ﾎﾟｯﾌﾟ体", 30)
        self.color = (0, 0, 255)
        self.scr = 0
        self.img = self.fonto.render("表示させる文字 ", 0, self.color)
        self.rct = self.img.get_rect()
...
def main():
    ...
    while True:
        ...
        # ビームが画面外に出たらリストから削除
        beams = [b for b in beams if not b.is_out()]
